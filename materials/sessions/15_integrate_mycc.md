...
成果物はここで完成する。このあとは[選択制の発展課題](../../workbook/advanced/README.md)へ進む。
...
[「どこから始めるか」](../../workbook/advanced/README.md#どこから始めるか)の表を目安にする。

次は[コマ16（発表・振り返り）](16_demo_review.md)である。自身の取り組みを発表する回で、番号のある通常回には含めない。
