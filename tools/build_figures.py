...
AST_IMAGE_SPECS = [
    ...
    ("08_fib_ast.svg",             "08_functions_recursion/tests/target.c"),
    ("08_mutual_rec_ast.svg",      "08_functions_recursion/tests/mutual_rec.c"),
    ("09_deref_write_ast.svg",     "09_lvalue_rvalue/tests/deref_write.c"),
    ("10_array_sum_ast.svg",       "10_types_arrays/tests/array_sum.c"),
    ("10_ptr_arith_ast.svg",       "10_types_arrays/tests/ptr_arith.c"),
    ("11_printf_number_ast.svg",   "11_strings_printf/tests/printf_number.c"),
    ("12_dot_access_ast.svg",      "12_struct_typedef/tests/dot_access.c"),
    ("12_arrow_access_ast.svg",    "12_struct_typedef/tests/arrow_access.c"),
    ("13_sizeof_test_ast.svg",     "13_sizeof_malloc_list/tests/sizeof_test.c"),
    ("13_list_min_ast.svg",        "13_sizeof_malloc_list/tests/list_min.c"),
