...
AST_IMAGE_SPECS = [
    ...
    ("10_ptr_sum_ast.svg",         "10_types_pointers/tests/ptr_sum.c"),
    ("10_ptr_arith_ast.svg",       "10_types_pointers/tests/ptr_arith.c"),
    ("11_printf_number_ast.svg",   "11_strings_printf/tests/printf_number.c"),
    ("12_dot_access_ast.svg",      "12_struct/tests/dot_access.c"),
    ("12_arrow_access_ast.svg",    "12_struct/tests/arrow_access.c"),
