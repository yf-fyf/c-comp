...
AST_IMAGE_SPECS = [
    ("02_add_mul_ast.svg",         "01_interpreter/tests/add_mul.c"),
    ("03_complex_ast.svg",         "02_arithmetic_codegen/tests/complex.c"),
    ("04_variables_ast.svg",       "03_variables/tests/target.c"),
    ("05_if_else_ast.svg",         "04_if_else/tests/target.c"),
    ("06_while_ast.svg",           "05_loops/tests/target.c"),
    ("06_for_ast.svg",             "05_loops/tests/for_count.c"),
    ("07_fib_ast.svg",             "06_functions_recursion/tests/target.c"),
    ("07_mutual_rec_ast.svg",      "06_functions_recursion/tests/mutual_rec.c"),
    ("08_deref_write_ast.svg",     "07_lvalue_rvalue/tests/deref_write.c"),
    ("10_ptr_sum_ast.svg",         "09_pointer_arith/tests/ptr_sum.c"),
    ("10_ptr_arith_ast.svg",       "09_pointer_arith/tests/ptr_arith.c"),
    ("11_printf_number_ast.svg",   "10_strings_data_section/tests/printf_number.c"),
    ("13_dot_access_ast.svg",      "12_struct_malloc_list/tests/dot_access.c"),
    ("13_arrow_access_ast.svg",    "12_struct_malloc_list/tests/arrow_access.c"),
    ("13_sizeof_test_ast.svg",     "12_struct_malloc_list/tests/sizeof_test.c"),
    ("13_list_min_ast.svg",        "12_struct_malloc_list/tests/list_min.c"),
    ("14_global_counter_ast.svg",  "13_globals_scope/tests/global_min.c"),
    ("14_global_shadow_ast.svg",   "13_globals_scope/tests/shadow_min.c"),
    ("15_define_min_ast.svg",      "14_preprocess_multifile/tests/define_min.c"),
]
