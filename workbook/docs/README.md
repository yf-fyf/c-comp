...
学習者向けドキュメント。「読むもの」と「引くもの」に分かれている。

## 読むもの

| 文書 | 内容 | いつ |
|------|------|------|
| [`getting_started.md`](./getting_started.md) | 進め方・環境の用意・全24コマ一覧・コマ16 のあと | **最初に** |
...
| 場所 | 内容 |
|------|------|
| [`../advanced/README.md`](../advanced/README.md) | 発展課題 25 トピックの一覧と依存関係 |
| [`../porting/README.md`](../porting/README.md) | C 移植・セルフホスト（C 実装の規約、移植対応表を含む） |
