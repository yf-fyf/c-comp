...
| 文書 | 内容 | 読みどき |
|------|------|---------|
| [`getting_started.md`](./getting_started.md) | 進め方・環境の用意・読む順序・全16コマ（01〜16）一覧・コマ15 のあと | **最初に**（入口） |
...
| [`code_example.md`](./code_example.md) | 各コマ終了時点でコンパイルできるプログラム（コマ1〜15） | 引くもの。冒頭に目次がある |
