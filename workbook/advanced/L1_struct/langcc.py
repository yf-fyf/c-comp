#!/usr/bin/env python3
"""langcc — 構造体コピーつきコンパイララッパー(完成済み。編集しない)
...
使い方:
    ...
    python3 scaffold/test_runner.py --compiler advanced/L1_struct/langcc.py

環境変数:
    LANGCC_COMPILER  ベースにするコンパイラ(既定: workbook/final/mycc.py)
    LANGCC_PASSES    structcopy.py のあるディレクトリ(既定: このファイルの場所)
"""
...
def main():
    ...
    sc = load_module("langcc_structcopy", passes_dir / "structcopy.py")
