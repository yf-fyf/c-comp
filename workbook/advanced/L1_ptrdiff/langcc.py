#!/usr/bin/env python3
"""langcc — ポインタ差つきコンパイララッパー(完成済み。編集しない)
...
使い方:
    ...
    python3 scaffold/test_runner.py --compiler advanced/L1_ptrdiff/langcc.py

環境変数:
    LANGCC_COMPILER  ベースにするコンパイラ(既定: workbook/final/mycc.py)
    LANGCC_PASSES    ptrdiff.py のあるディレクトリ(既定: このファイルの場所)
"""
...
def main():
    ...
    pd = load_module("langcc_ptrdiff", passes_dir / "ptrdiff.py")
